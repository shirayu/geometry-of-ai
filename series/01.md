...
PCAの線形性という限界に対する画期的な解答が、2000年のScience誌に相次いで発表された。**Isomap**（Tenenbaum et al., 2000）と**LLE（Locally Linear Embedding）**（Roweis & Saul, 2000）である。
...
この「低次元潜在多様体」という見方は、後のオートエンコーダや生成モデルの文脈で再解釈され、第9回で扱うVAEなどへと繋がっていく。
