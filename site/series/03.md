...
第2回で、ノルムが「三重の意味」を担っていたことを見た。意味の強度、確信度、スケーリングノイズ、これらが混在し、制御が困難だった。三つの意味を後から仕分けようとする限り、この混線はおそらく解けない。
...
この対応表に、本講義の核心が凝縮されている。星は、広大な空間に離散的に配置された「意味の所在」である。その星が**どこにあるか（方向、配置）** だけを見て、**どれだけ明るいか（大きさ、ノルム）** は見ない。星の明るさをあえて捨てる。これが第2回で見た「ノルムの呪い」への回答である。意味は、星の配置（角度）だけが担う。

> [!NOTE]
> **第1回の「星空」との違い：** 第1回でも「星＝単語、星座＝トピック」という比喩を使ったが、あれは**離散的な星空**だった。星はあっても、それらを浮かべる連続的な空間がなかった。本回で単位球面という連続的な夜空を得て、星は初めて「方向で意味を持つ点」になる。以降の章でも「星」は登場するが、その本質は一貫して「離散的な意味の所在を、配置（方向）で意味づける」ことにある。
...
| **vMF分布** | 球面上の方向分布。集中度 $\kappa$ が分布の鋭さを制御 | Softmaxとの形式的対応。第4回と第7回に接続 |
| **球面設計の限界** | ノルムに意味がある場合、回帰タスク等では適さない | 「球面が常に良い」という過剰一般化を防ぐ |

球面制約は「長さと向きの混乱」を解消する強力な設計だが、あらゆる場面に効く万能薬ではない。ノルムが意味を持つタスクや、階層構造を表現したい場面では別の幾何学（第12回：双曲空間）が有効になる。どの空間を選ぶか、という問いは、本講義を通じて繰り返し問われる。
...
> [!TIP]
> **Transformerに馴染みのない読者へ：** 本回ではnGPTの設計思想を通じて「球面制約」の意味を理解した。nGPTが改良の対象としているTransformerそのものの全体像（どんな構成要素があり、それぞれが何をしているのか）については、第6回「Transformerという測量士」の導入の後に整理する。第4回と第5回はSoftmaxとマージンという、Transformerに限定されない概念を扱うので、Transformerの詳細を知らなくても読み進められる。
