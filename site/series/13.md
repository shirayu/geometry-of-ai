...
[第2回](02.md)で述べたように、高次元空間では以下の現象が起きる。第2回はこの現象を高次元の「奇妙さ」の導入として簡潔に示したが、本回ではこれを起点に、赤道集中現象やMoEの設計原理といった、より進んだ帰結まで踏み込む：
...
- <a id="ref-beyer1999"></a>Beyer, K., Goldstein, J., Ramakrishnan, R., & Shaft, U. (1999). When Is "Nearest Neighbor" Meaningful? *ICDT 1999*, 217–235.
    - 高次元でのkNN崩壊を最初に理論的に示した論文。距離集中の定量的な条件を導出。
- <a id="ref-angiulli2018"></a>Angiulli, F. (2018). On the Behavior of Intrinsically High-Dimensional Spaces: Distances, Direct and Reverse Nearest Neighbors, and Hubness. *Journal of Machine Learning Research*, 18(170), 1–60.
    - 高次元空間での距離・近傍・ハブ性の統一的な分析。hubness現象の理論的な背景。
- <a id="ref-radovanović2010"></a>Radovanović, M., Nanopoulos, A., & Ivanović, M. (2010). Hubs in Space: Popular Nearest Neighbors in High-Dimensional Data. *Journal of Machine Learning Research*, 11, 2487–2531.
    - 高次元データにおけるハブ（多くの点の近傍になる点）の出現メカニズムを分析。

### 近傍探索・ベクトル検索

- <a id="ref-indyk1998"></a>Indyk, P., & Motwani, R. (1998). Approximate Nearest Neighbors: Towards Removing the Curse of Dimensionality. *STOC 1998*, 604–613.
...
- <a id="ref-meta2025"></a>Meta AI (2025). The Llama 4 herd: The beginning of a new era of natively multimodal AI innovation.
