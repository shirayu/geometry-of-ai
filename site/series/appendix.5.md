...
本Appendixは、講義本編（特に[第4回「分類の再統一 I ～Softmaxと情報幾何学～」](04.md)）の発展的内容として、**Softmaxの背後にある情報幾何学の双対構造**を扱うものである。
...
| [第4回](04.md)（Softmaxと情報幾何学） | Softmax＝ルジャンドル変換の勾配写像。双対平坦構造が自然勾配とFisher情報行列の背景を与える |
| [第5回](05.md)（マージンの幾何学） | e-測地線（ロジット空間の直線）上での分離が、角度マージンの議論と接続する |
