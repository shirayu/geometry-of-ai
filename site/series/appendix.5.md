...
「まっすぐ」とは何かを、ユークリッド空間で考えたことがある人はいないだろう。直線は直線であり、それ以外の候補は存在しないからだ。ところが、情報幾何学の最も深い洞察の一つは、確率分布の空間には **2種類の「まっすぐ」** が存在するということである。ユークリッド空間の常識が通用しない場所に来ている。確率空間の本質的な非対称性がここに反映されている。
