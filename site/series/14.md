...
「トポロジー的に複雑な表現」を検出できるとして、では層を重ねたネットワークは、その複雑さをどう扱っているのか。Naitzat et al. (2020) は、ニューラルネットワークの決定境界のトポロジーを研究した（"Topology of Deep Neural Networks", arXiv:2004.06093）。
