...
これまで、私たちは望遠鏡で星の配置——表現空間の大域的な形——を眺めてきた。本回は道具を顕微鏡に持ち替え、その形の内側にある「穴」や「ループ」を覗き込む。望遠鏡が全体の配置を捉えるなら、顕微鏡は局所に潜む構造を拾い上げる。
...
**パーシステントホモロジー（Persistent Homology）** は、この問いに対する洗練された回答を与える。そのアイデアは：
