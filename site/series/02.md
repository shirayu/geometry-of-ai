...
どちらの問いも、突き詰めれば同じ結論に行き着く。中途半端に持たせるくらいなら、いっそ立場を決めてしまえばよい。この問いに対する一つの回答が、「最初から単位球面上で計算する」という設計方針である。次回、この方針を「プラネタリウムの建設」として導入する。

## 補足：情報幾何学からの視点

[第0回](00.md)で導入した情報幾何学の観点から、ノルムの問題を再考しよう。
...
[第4回](04.md)では、Softmaxを取り上げ、「温度」や「スケール」が確率分布の空間でどのような意味を持つかを整理する。

## まとめ：ノルムの呪いと高次元の逆説

一つの数値に三つの意味を詰め込んでいたことが、そもそもの発端だった。混線を放置したまま高次元に踏み込むと、直感はさらに裏切られる。距離は近づくどころか一様に遠ざかり、代わりに角度という「空きスペース」が思わぬ豊かさを生んでいた。
