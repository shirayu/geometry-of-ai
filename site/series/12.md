...
球面は正の曲率を持つ。通常の2次元球面（球の表面、 $\mathbb{S}^2$ ）の場合、ある点から測地線距離 $r$ 離れた点の集合（測地線円の「円周」）の長さは $2\pi \sin(r)$ となる。曲がっている分、周囲はユークリッド空間より速く広がってくれるに違いない。そう期待したくなる。
...
円板は有限の広さしか持たない。それなのに、この中に無限に広がる双曲空間を収めるという。矛盾しているように聞こえる。だが、そうはならない。
...
- <a id="ref-gu2019"></a>Gu, A., Sala, F., Gunel, B., & Ré, C. (2019). Learning Mixed-Curvature Representations in Product Manifolds. *ICLR 2019*.
...
- <a id="ref-cannon1997"></a>Cannon, J. W., Floyd, W. J., Kenyon, R., & Parry, W. R. (1997). Hyperbolic Geometry. *Flavors of Geometry (MSRI Publications, Vol. 31)*, 59–115.
