...
const PAGES: { file: string; link: string; quizFile?: string; quizLink?: string; part?: string }[] = [
    ...
    { file: '04.md', link: '/series/04', quizFile: '04/quiz.md', quizLink: '/series/04/quiz', part: '第2部 統一的視点への接続' },
    { file: '05.md', link: '/series/05', quizFile: '05/quiz.md', quizLink: '/series/05/quiz', part: '第2部 統一的視点への接続' },
    { file: '06.md', link: '/series/06', quizFile: '06/quiz.md', quizLink: '/series/06/quiz', part: '第2部 統一的視点への接続' },
    { file: '07.md', link: '/series/07', quizFile: '07/quiz.md', quizLink: '/series/07/quiz', part: '第2部 統一的視点への接続' },
